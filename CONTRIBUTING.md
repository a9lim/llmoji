...
- The `HookInstaller` subclass with `system_injected_prefixes` (empty if the harness doesn't inject system-role-as-user-text payloads) and `system_prompt_doc_path`.
