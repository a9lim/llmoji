...
- [ ] If touching `llmoji.taxonomy`, `llmoji.synth_prompts`, the `HookInstaller` interface, the journal schema, or the bundle schema: please flag this as a cross-corpus invariant change in the description (the HF dataset card needs a hand-edit on those)
